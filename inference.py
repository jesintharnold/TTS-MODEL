    ...
    while True:
        ...
        if text.lower() == "exit":
            ...
            try:
                ...
                with torch.no_grad():
                    predicted_mel_spectrogram, predicted_durations, mel_len, mel_mask = model(
                        phoneme_indices, src_lens, spectogram=None, durations=None
                    )
                    
                    print("Predicted Durations (after processing):", predicted_durations)
